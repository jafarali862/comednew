        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card mb-5">
                    ...
                    <div class="card-body">
                        <form  action="{{route('field-addition.store')}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="" name="type" class="form-control" placeholder="Field Type">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="" name="validation[]" class="form-control" placeholder="Validation">
